...
try{
 ...
 assert.ok(clear.cyan>100);assert.equal(blocked.cyan,0);assert.equal(restored.cyan,clear.cyan);assert.equal(blocked.metrics.drawCalls,7);assert.deepEqual(errors,[]);
