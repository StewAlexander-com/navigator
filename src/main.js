...
worker.onmessage=({data})=>{
 ...
 if(data.geometry)worldLayer.setBuildings({...data.geometry,far:data.far});metrics.stream=data.stream;lastBuild=[data.x,data.y];lastStreamHeading=data.heading;
